...
int main(int argc, char* argv[]) 
{
    ...
    n_stazioni = carica_stazioni(argv[1], stazioni);
    stampa_stazioni(n_stazioni, stazioni);
    printf("n_stazioni = %d\n", n_stazioni);

    g = carica_rete(argv[1], stazioni, n_stazioni);

    printf("sono qui\n");

    stampa_pacchi(argv[2], stazioni, g, n_stazioni);
